...
document.getElementById("btn1").addEventListener("click", () => { // event listener for player 1 button
    ...
    document.getElementById("dice2").src = dice[4]; // set the image src for dice 2
        ...
        let marksString = "Score: " + marks[0]; // convert the score to string
        document.getElementById("score1").innerHTML = marksString; // set the score for player 1
...
document.getElementById("btn2").addEventListener("click", () => { // event listener for player 2 button
    ...
    document.getElementById("dice2").src = dice[4]; // set the image src for dice 2
        ...
        let marksString = "Score: " + marks[1]; // convert the score to string
        document.getElementById("score2").innerHTML = marksString; // set the score for player 2
